...
def admin_login_post():
    ...
    if _usuario=="santi" and _password=="1978":
        session["login"]=True
...
def admin_libro_borrar():
    ...
    if os.path.exists("templates/sitio/img/"+str(libro[0]['imagen'])):
        os.unlink("templates/sitio/img/"+str(libro[0]['imagen']))
...
@app.route('/sitio/libros/correo', methods=['POST'])
